...
class ExperimentalAuthentication(requests.auth.AuthBase):
    ...
    def __call__(self, r: requests.PreparedRequest) -> requests.PreparedRequest:
        ...
        return r
class HttpWrapper:
    def __init__(self, cli_context: 'CliContextObj', base_url: str, extra_kwargs: requests_types.BaseRequestKwargs | None = None):
        self._cli_context = cli_context
...
class ServiceClient(HttpWrapper):
    def __init__(self, cli_context: 'CliContextObj', base_url: str):
        super().__init__(cli_context, base_url, extra_kwargs={'auth': ExperimentalAuthentication(cli_context)})
        self.anonymous = HttpWrapper(cli_context, base_url, )
...
class CliContextObj():
    ...
    def orchestrator(self):
        if self._orchestrator is None:
            self._orchestrator = ServiceClient(self, self.sdk_instance.base_environment_url)
